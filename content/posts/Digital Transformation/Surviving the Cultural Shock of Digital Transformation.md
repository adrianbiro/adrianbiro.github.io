+++
title = 'Surviving the Cultural Shock of Digital Transformation'
...
- Minor shifts in reporting methods and revenue recognition.

- Changes in internal terminology and company nomenclature.

- New approval steps for routine procurement or budget tasks.

- Alterations to how data is entered and who owns the accuracy of that data.
...
- Repeatable processes replace ad hoc decision making.

- System enforced approvals replace verbal agreements.

- Formal data governance replaces informal record keeping.

- Data ownership shifts from technical departments to the business units.
